...
<body>
	...
	<div class="container">
		...
		<form:form class="form-style-4" id="formGreeting" action="${action}"
			method="post" modelAttribute="greeting">
			<form:hidden path="id" />
			<label for="field1"><span>Text</span>
			<form:input path="text" name="field1" type="text" value="${greeting.text}" /></label>
